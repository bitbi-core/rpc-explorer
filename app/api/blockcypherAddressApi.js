...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
	return new Promise(async (resolve, reject) => {
		...
		var mainnetUrl = `https://api.blockcypher.com/v1/btb/main/addrs/${address}?limit=${limitOffset}`;
		var testnetUrl = `https://api.blockcypher.com/v1/btb/test3/addrs/${address}?limit=${limitOffset}`;
