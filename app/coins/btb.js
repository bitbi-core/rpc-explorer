...
const Decimal9 = Decimal.clone({ precision:9, rounding:5 });

const btcFun = require("./btbFun.js");

const blockRewardEras = [ new Decimal9(10000) ];
for (let i = 1; i < 408; i++) {
	let previous = blockRewardEras[i - 1];
	const drop = previous.dividedBy(20);
	blockRewardEras.push(new Decimal9(previous).sub(drop));
}
...
module.exports = {
	...
	miningPoolsConfigUrls:[
		"https://raw.githubusercontent.com/btc21/Bitbi-Known-Miners/master/miners.json",
	...
	currencyUnitsByName:{"BTB":currencyUnits[0], "mBTB":currencyUnits[1], "bits":currencyUnits[2], "wen":currencyUnits[3]},
