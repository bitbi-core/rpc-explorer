	...
	items: [
		{
			...
			summary: "The Bitbi Genesis Block.",
			alertBodyHtml: "This is the first block in the Bitbi blockchain, known as the <b>Genesis Block</b>. This block was mined by Bitbi's creator <b>Satoshi Nakamoto</b>.<br/>Read more here: <a href='https://en.bitcoin.it/wiki/Genesis_block'>bitcoin.it/wiki/Genesis_block</a>.",
		...
		},
		{
			...
			alertBodyHtml: "Multiple transactions in Block #71,036, including this one, included MANY OP_CHECKSIG commands, causing nodes to perform unnecessary work, and helped identify a possible denial-of-service (DoS) attack. A new version of Bitbi was quickly released. The new version did not cause a fork on the main network, though it did cause one on the test network (where someone had played around with the attack more)." ,
		...
		},
		{
			...
			alertBodyHtml: "In this first-known BTB-to-fiat transaction, 5,050 BTB were exchanged for 5.02 USD, at an effective exchange rate of ~0.001 USD/BTB.",
		...
		},
		{
			...
			alertBodyHtml:"This address corresponds to a Bitbi Script (<span class='font-data'>6e879169a77ca787</span>) that allows anyone who can demonstrate a SHA1 collision to spend from it. On September 13, 2013 this address was funded as a SHA1-collision bounty and it continued to accumulate 'bounty donations' for over 2 years when, on February 23, 2017 a total of 1.62 BTB were spent from this address in <a href='./tx/8d31992805518fd62daa3bdd2a5c4fd2cd3054c9b3dca1d78055e9528cff6adc'>8d31992805...</a>.",
		...
		},
		{
			...
			alertBodyHtml:"This address corresponds to a Bitbi Script (<span class='font-data'>6e879169a87ca887</span>) that allows anyone who can demonstrate a SHA256 collision to spend from it. On September 13, 2013 this address was funded as a SHA256-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://bitcointalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
		...
		},
		{
			...
			alertBodyHtml:"This address corresponds to a Bitbi Script (<span class='font-data'>6e879169a97ca987</span>) that allows anyone who can demonstrate a RIPEMD160(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a RIPEMD160(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://bitcointalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
			...
			alertBodyHtml:"This address corresponds to a Bitbi Script (<span class='font-data'>6e879169aa7caa87</span>) that allows anyone who can demonstrate a SHA256(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a SHA256(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://bitcointalk.org/index.php?topic=293382.0"
		},
		{
			type: "blockheight",
		...
		},
		{
			...
			summary: "First block of subsidy era #2 (25 BTB).",
		...
		},
		{
			...
			summary: "First block of subsidy era #3 (12.5 BTB).",
			referenceUrl: "https://github.com/bitcoin/bitcoin/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			summary: "First block of subsidy era #4 (6.25 BTB).",
			referenceUrl: "https://github.com/bitcoin/bitcoin/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			alertBodyHtml: "With the coinbase message 'Times 09/Apr/2020 With $2.3T Injection, Fed's Plan Far Exceeds 2008 Rescue', this final block of subsidy era #3 (12.5 BTB) echoes the spiritual call-to-action of <a href='./block/000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f'>Satoshi's genesis block</a>.",
		},
		{
			type: "tx",
			date: "2017-08-24",
		...
		},
		{
			...
			blockHeight: 57043,
			summary: "The 'Bitbi Pizza' transaction.",
			alertBodyHtml: "This is the famous 'Bitbi Pizza' transaction, one of the earliest 'real-world' transactions, in which 10,000 BTB was paid for 2 large pizzas worth ~41 USD (at an effective exchange rate of ~$0.004/BTB).",
		...
		},
		{
			...
			referenceUrl2: "https://www.reddit.com/r/Bitbi/comments/7mhoks/til_in_2011_a_user_running_a_modified_mining/"
		},
		{
			type: "blockheight",
			date: "2009-01-12",
		...
		},
		{
			...
			alertBodyHtml: "This coinbase transaction completely fails to collect the block's mining reward. 12.5 BTB were lost.",
		...
		},
		{
			...
			alertBodyHtml: "On May 5, 2020, 50 BTB mined on Feb 9, 2009 (~1 month after Satoshi mined the Genesis block), moved unexpectedly after being dormant for 11+ years. Some observers wondered if they were coins from Satoshi's stash (they likely <a href='https://twitter.com/zackvoell/status/1263120133054255104'>were not</a>) and got excited.",
		...
		},
		{
			...
			summary: "July 2020 Twitter hack BTB address",
			alertBodyHtml: "On July 15, 2020 a hack involving many prominent Twitter accounts, including Elon Musk's, Bill Gates', and Cash App's, scammed many people to send BTB to this address.",
		...
		},
		{
			...
			alertBodyHtml: "This transaction from November 2011 spends 11 UTXOs worth 50,000 BTB to create a single 550,000 BTB UTXO. This is currently the largest output transaction.",
		...
		},
		{
			...
			blockHeight: 230009,
			summary: "The Bitbi whitepaper embedded in the Bitbi blockchain.",
			alertBodyHtml: "This transaction encodes the Bitbi whitepaper PDF in 945 of its 947 outputs. You can view the PDF, decoded from data served by your own node here: <a href='./bitcoin-whitepaper'>bitcoin whitepaper</a>. Or read more about the technical details - ",
		...
		},
		{
			...
			alertBodyHtml: "Two of the transactions sent to this address encode the IP address of a botnet's command-and-control server. Using the censorship-resistant Bitbi network to serve this data makes the botnet more resistant to takedown. The output value '6957' (in transaction <a href='./tx/35ef7fa5dd1e4d572279a74a83082bd3e77a0c3a468723b5def5d014ed634e84'>35ef7fa5dd…</a>) and the output value '36305' (in transaction <a href='./tx/3a1fcdea5495fb3a1aa410772860afd7841ba8830ffc0ab474d4d69458244e42'>3a1fcdea54…</a>) combine to encode the IPv4 address '209.141.45.27'.",
		...
		},
		{
			...
			alertBodyHtml: "Shortly before a $1B+ USD Tesla treasury investment into Bitbi was announced, Elon Musk updated his Twitter profile to just say '#Bitbi' and cryptically tweeted 'It was inevitable'. Miner 'yhc5t3p' with F2Pool immortalized the tweet soon after.",
		...
		},
		{
			...
			summary: "Diario El Salvador 6/Jun/2021 Bitbi tendra validez legal",
			alertBodyHtml: "Immortalizing the proposed legislation in El Salvador to classify bitcoin as legal tender in the country (a bill written in collaboration with <a href='https://Strike.me'>Strike.me</a>) Slush Pool embedded the headline: 'Diario El Salvador 6/Jun/2021 Bitbi tendra validez legal'.",
		...
		},
		{
			...
			alertBodyHtml: "This interesting transaction exists in the blockchain only because of special coordination with F2Pool. Because this transaction spends Pay-to-Taproot outputs, and because it was created before Taproot activation, it was considered \"non-standard\" and would not be relayed across the Bitbi network, despite technically being valid. Therefore, as a technical demonstration, <a href='https://b10c.me'>https://b10c.me</a> coordinated with F2Pool to mine this non-standard transaction, wherein the P2TR outputs were effectively anyone-can-spend outputs.",
		...
		// testnet
		{
			...
			summary: "The Bitbi (regtest) Genesis Block.",
			alertBodyHtml: "This is the first block in the Bitbi blockchain, known as the 'Genesis Block'. You can read more about <a href='https://en.bitcoin.it/wiki/Genesis_block'>the genesis block</a>.",
			referenceUrl: "https://en.bitcoin.it/wiki/Genesis_block"
		},
		{
			type: "tx",
