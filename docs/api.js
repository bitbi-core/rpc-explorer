module.exports = {
	...
	"routes":[
		...
		// blockchain
		{
			...
			"desc":"Returns the current supply of Bitbi. An estimate using a checkpoint can be returned in 2 cases: on 'slow' devices, and before the UTXO Set snapshot is loaded.",
			"returnType":"number"
		},
		...
		// mempool
		{
			...
			"desc":"Returns the number of transactions in Bitbi Core's mempool.",
			"returnType":"integer"
		},
		...
		// price
		{
			"category":"price",
			"url":"/api/price",
			"desc":"Returns the price of 1 BTB, in USD, EUR, GBP, and XAU",
			"returnType":"json"
		},

		{
			...
			"desc":"Returns the price of 1 BTB, in one of USD, EUR, GBP, XAU",
...

		{
			...
			"desc":"Returns the market cap of Bitbi, in one of USD, EUR, GBP, XAU",
			"params":[{name: "currency", "options": ["usd", "eur", "gbp", "xau"]}],
			"returnType":"number",
		...
		// fun
		{
			"category":"fun",
			"url":"/api/quotes/all",
			"desc":"Returns the full curated list of Bitbi quotes.",
			"returnType":"json"
		},

		{
			...
			"desc":"Returns the Bitbi quote with the given index from the curated list.",
			"returnType":"json",
...

		{
			...
			"desc":"Returns a random Bitbi quote from the curated list.",
			"returnType":"json"
		},
